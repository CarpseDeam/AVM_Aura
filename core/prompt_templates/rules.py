# aura/core/prompt_templates/rules.py

class MasterRules:
    """
    A centralized store for the core, unbreakable laws governing AI agent behavior.
    Importing from this class ensures consistency across all prompts.
    """
    ...
    **LAW: RAW CODE OUTPUT ONLY**
    - Your entire response MUST be only the raw source code for the assigned file.
    - Do not write any explanations, comments, or markdown before or after the code block.
    """
